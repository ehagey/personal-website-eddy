...
const PracticalLessonsAIBlogPost = () => {
  return <BlogPost title="Practical Lessons from a Student Building AI Agents" date="May 3, 2025" slug="practical-lessons-ai-agents" content={<div>
      ...
      <p className="mb-4">This is probably the most valuable lesson I have learned. Don't spend weeks trying to perfect a design. Build something functional as quickly as possible, and then improve based on real feedback. For any project or research problem I am working on, I give myself 24 hours to have a functional MVP that assesses what is achievable, what is the easy part, what is the hard part, and so on.</p>
      
      <p className="mb-4">This helps discover the shortest path to a working solution.</p>
