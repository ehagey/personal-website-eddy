...
const PracticalLessonsAIBlogPost = () => {
  return <BlogPost 
    ...
    content={<div>
      ...
      <p className="mb-4"> Together, we've built AI agents that automated workflows with 90+% accuracy and cut processing times from days to minutes. Launched the <a href="https://aihealthinstitute.org/" target="_blank" rel="noopener noreferrer">AI Health Institute</a> and worked on so many other exciting projects. Here's what's worked (and failed) for me.</p>
