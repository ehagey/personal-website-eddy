...
const PracticalLessonsAIBlogPost = () => {
  return <BlogPost 
    ...
    content={<div>
      ...
      <p className="mb-4">This is probably the most valuable lesson I have learned. Don't spend weeks trying to perfect a design. Build something functional as quickly as possible, and then improve based on real feedback. For any project or research problem I am working on, I give myself ~48 hours to have a functional MVP that assesses what is achievable, what is the easy part, what is the hard part, and so on. This helps discover the shortest path to a working solution.  </p>
      
      <p className="mb-4">Implementation often reveals insights that no amount of planning can uncover.</p>
