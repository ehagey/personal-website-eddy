      ...
      content={
        <div>
          ...
          <p className="mb-4">
            ...
            <p className="mb-4">
            What is someone's "full potential" you ask? Does it manifest in academic achievements, professional success, social connections, physical wellbeing, or something entirely different?
            </p>
