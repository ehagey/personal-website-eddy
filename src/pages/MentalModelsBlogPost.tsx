  ...
  return <BlogPost 
    ...
    content={
      <div>
        ...
        <p className="mb-6">A person's quality of thinking largely determines the quality of life. Life unfolds as a series of interconnected decisions, where each choice shapes future possibilities and outcomes. For example, where we choose to go to school affects the people we encounter, the relationships we form, the geographic opportunities that emerge, and ultimately the entire trajectory of our personal and professional lives. Rather than thinking and making decisions in whatever way is most natural, the most effective thinkers construct a toolbox of different analytical tools, borrowed from physics, biology, economics, psychology, and other disciplines. These models of thinking become leverage that allow them to see solutions and patterns invisible to thinkers who confine themselves within a single way of thinking.</p>
