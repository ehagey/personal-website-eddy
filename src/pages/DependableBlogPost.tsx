...
const DependableBlogPost = () => {
  return <BlogPost title="Become Someone People can Depend on" date="April 13, 2025" slug="become-someone-people-can-depend-on" content={<div>
          ...
          <p className="mb-4">Discipline is not about rigidity. It's about care. It's how you protect what matters—your goals, your relationships, your word. When you work hard, show up early, stay present, and when you do more than what's expected or required, you don't just get results. You become someone reliable. Someone capable. Someone people can depend on and trust.</p>
