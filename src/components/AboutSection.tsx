    ...
    margin: '0 auto'
      ...
      marginBottom: '25px'
        ...
        color: 'var(--site-text-muted)'
          ...
          }}>Professor Maxime Cohen</a>, where our research focuses on AI. A major part of our work involves extensive industry collaborations to build and deploy practical AI agents. Additionally, our work has been featured in <a href="https://hbr.org/2025/10/what-happens-when-ai-sets-wages" target="_blank" rel="noopener noreferrer" style={{
            color: 'var(--site-link)',
            textDecoration: 'underline'
