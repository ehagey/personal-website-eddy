        ...
        <div className="flex flex-col gap-16">
          <div className="flex flex-col lg:flex-row gap-6 items-start">
            ...
            animationDelay: '0.2s'
              ...
              <h2 className="heading-lg mb-2">My experience and interests lie in AI and data analytics. Previously, I have built RAG and Ontology frameworks for a domain-specific Large Language Model. Currently, my interest and focus is in AI agents and in developing robust evaluation and benchmarking criteria for LLMs.</h2>
